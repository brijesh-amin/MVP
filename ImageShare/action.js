...
run: function(parameters) {
    obj["base_url"] = document.URL;
    obj["title"] = document.title;
//    obj["version"] = $.fn.jquery;
    runthis();
    parameters.completionFunction(obj);
},
...
function addImage( imageToAdd ) {
    ...
    if(URLs.indexOf(imageURL) != -1 || imageURL.length === 0)
        return;
    ...
    URLs[URLs.length] = imageURL;
    obj["URL_"+numberOfImages] = imageURL;
    numberOfImages ++;
}
